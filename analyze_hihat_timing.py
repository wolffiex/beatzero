...
if len(onsets) > 1:
    ...
    plt.axvline(x=median_bpm, color='red', linestyle='--', label=f'Median: {median_bpm:.1f} BPM')
    plt.axvline(x=most_common_bpm, color='green', linestyle='-', label=f'Mode: {most_common_bpm:.1f} BPM')
